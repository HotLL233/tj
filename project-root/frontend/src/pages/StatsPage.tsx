                ...
                >
                  <FormControl size="small" sx={{ minWidth: 150 }}>
                    ...
                    >
                      ...
                      {[...new Set(ul.map((r) => r.user_name))].map((n) => (
                          ...
                          {ul.length === 0 ? (
                            ...
                            ul.map((r, i) => (
                              <TableRow key={r.id} hover>
                                ...
                                <TableCell>{r.method_name || "-"}</TableCell>
                                <TableCell>{r.method_type || "-"}</TableCell>
                                <TableCell>
  ...
  return (
    <Box>
      ...
      <ConfirmDialog
        open={duo}
        title="删除用户记录"
        message={`确定要删除用户「${dun}」在所选日期范围内的所有记录吗？`}
        confirmText="删除"
        cancelText="取消"
        onConfirm={hdu}
