...
const App: React.FC = () => (<ErrorBoundary><UserProvider><Routes><Route element={<Layout />}>
  ...
  <Route path="/sample/stats" element={<ProtectedRoute requirePermission="stats:rd:access"><SampleStatsPage /></ProtectedRoute>} />
  ...
  <Route path="/stats" element={<ProtectedRoute requirePermission="stats:workload:access"><StatsPage /></ProtectedRoute>} />
  <Route path="/help" element={<ProtectedRoute requirePermission="manage:help"><HelpPage /></ProtectedRoute>} />
