...
export const deleteInstrument = (id: number): Promise<ApiResponse<null>> =>
  client.delete(`/instruments/${id}`).then((r) => r.data);
...
export const completeRdRecord = (id: number): Promise<ApiResponse<WorkRecord>> =>
  client.put(`/rd-records/${id}/complete`, {}).then(r => r.data);
