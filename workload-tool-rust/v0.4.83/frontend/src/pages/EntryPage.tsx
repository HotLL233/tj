            ...
            <TableBody>
              {todayRecords.map(rec => (
                <TableRow key={rec.id} hover sx={{ '&:last-child td': { borderBottom: 0 } }}>
                  ...
                  <TableCell sx={{ ...todayRecordCellSx, whiteSpace: 'nowrap' }}>{rec.user_name || '-'}</TableCell>
                  <TableCell sx={todayRecordCellSx}>{rec.method_name || '-'}</TableCell>
                  <TableCell sx={{ ...todayRecordCellSx, whiteSpace: 'nowrap' }}>{rec.method_type || '-'}</TableCell>
                  <TableCell sx={todayRecordCellSx}>
                  ...
                  <TableCell sx={{ ...todayRecordCellSx, fontWeight: 600, whiteSpace: 'nowrap' }}>{rec.quantity}</TableCell>
                  <TableCell sx={{ ...todayRecordCellSx, whiteSpace: 'nowrap' }}>{rec.high_item || '-'}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
