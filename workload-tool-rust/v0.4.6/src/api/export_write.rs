/// 导出 Excel 写入层 - v0.3.6 重写版本 / v0.4.6 倍率更新
...
pub fn write_sheet1(
    ...
    ws.set_column_width(CE, 10.0)?;  // 倍率
    ...
    // 写表头
    let headers = ["使用实验室", "项目代号", "液相仪器", "检测方法", "倍率", "检测数量", "液相检测量", "气相检测量", "项目检测总量"];
...
pub fn write_sheet2(
    ...
    ws.set_column_width(CF, 10.0)?;  // 倍率
    ...
    let headers = ["日期", "仪器", "实验室", "项目", "方法", "倍率", "数量", "按天数量总计"];
    for (i, h) in headers.iter().enumerate() {
        ws.write_with_format(HR, i as u16, *h, &fmt.fh)?;
    }
...
pub fn write_sheet3(
    ...
    let headers = ["项目", "实验室", "仪器", "方法", "倍率", "数量", "单价", "金额总计", "项目金额"];
    for (i, h) in headers.iter().enumerate() {
        ws.write_with_format(HR, i as u16, *h, &fmt.fh)?;
    }
...
pub fn write_sheet4(
    ...
    let headers = ["实验室", "项目", "仪器", "方法", "倍率", "数量", "单价", "数量总计", "金额总计", "实验室汇总"];
    for (i, h) in headers.iter().enumerate() {
        ws.write_with_format(HR, i as u16, *h, &fmt.fh)?;
    }
...
pub fn write_sheet5(
    ...
    let headers = ["录入时间", "实验室", "研发项目", "方法", "检测类型", "倍率", "数量", person_label];
    for (i, h) in headers.iter().enumerate() {
        ws.write_with_format(HR, i as u16, *h, &fmt.fh)?;
    }
...
pub fn write_sheet6(
    ...
    let headers = [person_label, "液相数量", "液相系数", "液相倍率", "液相汇总", "气相数量", "气相系数",
                   "气相倍率", "气相汇总", "理化数量", "理化系数", "理化倍率", "理化汇总", "个人汇总", "总额"];
    for (i, h) in headers.iter().enumerate() {
        ws.write_with_format(HR, i as u16, *h, &fmt.fh)?;
    }
...
pub fn write_sheet7(
    ...
    let headers = ["实验室", "项目", "液相数量", "液相单价", "液相倍率", "液相汇总",
                   "气相数量", "气相单价", "气相倍率", "气相汇总",
                   "理化数量", "理化单价", "理化倍率", "理化汇总", "项目汇总", "实验室汇总"];
    for (i, h) in headers.iter().enumerate() {
        ws.write_with_format(HR, i as u16, *h, &fmt.fh)?;
    }
...
pub fn write_sheet8(
    ...
    let headers = ["项目", "液相数量", "液相单价", "液相倍率", "液相汇总",
                   "气相数量", "气相单价", "气相倍率", "气相汇总",
                   "理化数量", "理化单价", "理化倍率", "理化汇总", "项目汇总"];
    for (i, h) in headers.iter().enumerate() {
        ws.write_with_format(HR, i as u16, *h, &fmt.fh)?;
    }
...
pub fn write_sheet9(
    ...
    ws.set_column_width(CD, 10.0)?;  // 倍率
    ...
    let headers = ["仪器编号", "检测量", "类型", "倍率", "按类型汇总"];
    for (i, h) in headers.iter().enumerate() {
        ws.write_with_format(HR, i as u16, *h, &fmt.fh)?;
    }
...
pub fn write_sheet10(
    ...
    ws.set_column_width(CB, 10.0)?;  // 倍率
