...
async fn download_template(State(pool): State<DbPool>) -> Result<impl IntoResponse> {
    ...
    let response = Response::builder()
        ...
        .header(
            ...
            "attachment; filename=master_data_import_v0.4.90.xlsx; filename*=UTF-8''%E4%B8%BB%E6%95%B0%E6%8D%AE%E4%B8%80%E9%94%AE%E5%AF%BC%E5%85%A5%E6%A8%A1%E6%9D%BF_v0.4.90.xlsx",
        )
...
fn build_simplified_template(conn: &Connection) -> Result<Vec<u8>> {
        ...
        .set_align(FormatAlign::Center);
    {
        ...
        ws.merge_range(0, 0, 0, 1, "主数据一键导入模板 v0.4.90", &title)?;
        let rows = [
