                          ...
                          {ul.length === 0 ? (
                            ...
                            ul.map((r, i) => (
                              <TableRow key={r.id} hover>
                                ...
                                <TableCell sx={{ whiteSpace: "normal", wordBreak: "break-word", minWidth: 148 }}>
                                ...
                                <TableCell sx={{ whiteSpace: "normal", wordBreak: "break-word", minWidth: 240 }}>{r.method_name || "-"}</TableCell>
