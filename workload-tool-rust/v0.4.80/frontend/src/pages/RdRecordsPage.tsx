              ...
              <TableRow hover sx={{ '&:last-child td': { borderBottom: 0 } }}>
                {columns.map(col => {
                  ...
                  if (col.name === 'lab_name') {
                    return (
                      <TableCell key={col.name} sx={{ fontSize: '0.8rem', minWidth: Math.max(col.width || 150, 150), whiteSpace: 'normal', wordBreak: 'break-word' }}>
                        {getGroupName(rec)}
                      </TableCell>
                    );
                  }
                  if (col.name === 'method_name') {
                    return (
                      <TableCell key={col.name} sx={{ fontSize: '0.8rem', minWidth: Math.max(col.width || 220, 220), whiteSpace: 'normal', wordBreak: 'break-word' }}>
                        {rec.method_name || '-'}
                      </TableCell>
                    );
                  }
                  ...
                  return (
                    <TableCell key={col.name} sx={{ fontSize: '0.8rem', whiteSpace: 'normal', wordBreak: 'break-word', minWidth: col.width || 100 }}>
