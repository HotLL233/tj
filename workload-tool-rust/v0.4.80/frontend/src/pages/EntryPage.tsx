            ...
            <TableBody>
              {todayRecords.map(rec => (
                <TableRow key={rec.id} hover sx={{ '&:last-child td': { borderBottom: 0 } }}>
                  ...
                  <TableCell sx={{ fontSize: '0.8rem', minWidth: 120, whiteSpace: 'normal', wordBreak: 'break-word' }}>{labName || '-'}</TableCell>
                  <TableCell sx={{ fontSize: '0.8rem', minWidth: 150, whiteSpace: 'normal', wordBreak: 'break-word' }}>{rec.project_name || '-'}</TableCell>
                  <TableCell sx={{ fontSize: '0.8rem', whiteSpace: 'nowrap' }}>{rec.user_name || '-'}</TableCell>
                  <TableCell sx={{ fontSize: '0.8rem', minWidth: 220, whiteSpace: 'normal', wordBreak: 'break-word' }}>{rec.method_name || '-'}</TableCell>
