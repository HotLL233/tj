...
const App: React.FC = () => (<ErrorBoundary><UserProvider><Routes><Route element={<Layout />}>
  ...
  <Route path="/manage/projects" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/groups" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/divisions" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/master-import" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/methods" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/trash" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/audit" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/backup" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/help" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/sampleinfo" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/users" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/layouts" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/forms" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/exports" element={<ProtectedRoute requireManage><ManagePage /></ProtectedRoute>} />
  <Route path="/manage/roles" element={<ProtectedRoute requireAdmin><AdminRolesPage /></ProtectedRoute>} />
  {/* v0.4.32: 角色管理（仅管理员） */}
