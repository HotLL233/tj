...
const getRdRecordColumnPercent = (key: string) => {
    ...
    <Box sx={{ p: 2 }}>
      ...
      <Box sx={{ mt: 3 }}>
        ...
        {recordsLoading && todayRecords.length === 0 ? (
          ...
          <TableContainer component={Paper} variant="outlined" sx={{ borderRadius: R, boxShadow: 'none', overflowX: 'hidden' }}>
                  ...
                  {visibleLayoutFields.map(field => (
                    <TableCell
                      ...
                      sx={{
                        ...
                        overflowWrap: 'anywhere',
                        wordBreak: 'break-word',
                        width: getRdRecordColumnPercent(field.key),
                        px: 0.75,
                      }}
                    >
                      {field.label}
