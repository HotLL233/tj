...
OutputBaseFilename=工作量统计工具_Rust_v0.2.17_Setup
SetupIconFile=D:\桌面\工作量统计工具项目\workload-tool-rust\v0.2.17\icon.ico
Compression=lzma
...
[Files]
Source: "D:\桌面\工作量统计工具项目\workload-tool-rust\v0.2.17\dist\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
Source: "D:\桌面\工作量统计工具项目\workload-tool-rust\v0.2.17\static\*"; DestDir: "{app}\static"; Flags: ignoreversion recursesubdirs
Source: "D:\桌面\工作量统计工具项目\workload-tool-rust\v0.2.17\icon.ico"; DestDir: "{app}"; Flags: ignoreversion
