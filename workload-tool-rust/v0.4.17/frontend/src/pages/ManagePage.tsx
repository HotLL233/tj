...
const ManagePage: React.FC = () => {
  ...
  useEffect(() => { if (tb === 'audit') la(1); if (tb === 'backup') loadBk(); if (tb === 'methods') { lmt(); lm(); } if (tb === 'trash') loadTrash(); if (tb === 'help') loadHelpDocs(); }, [tb, la, lmt, lm]);
