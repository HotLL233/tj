        ...
        : ps.map(p => (
            ...
            >
              ...
              <Box sx={{ display: 'flex', gap: 0.5, mt: 0.5 }}>
                ...
                <Button size="small" variant="outlined" onClick={() => handleProjectStatusChange(p, (p.project_status || 'ongoing') === 'archived' ? 'ongoing' : 'archived')} sx={{ borderRadius: R, minHeight: 28 }}>{(p.project_status || 'ongoing') === 'archived' ? 'Enable' : 'Archive'}</Button>
