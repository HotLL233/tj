...
const AdminRolesPage: React.FC = () => {
  ...
  const ROLE_TEMPLATES = [
    ...
    { label: '分析检测员', name: '分析检测员', description: '分析检测相关管理权限', permissions: ['entry:workload', 'manage:projects', 'manage:groups', 'manage:methods', 'manage:trash', 'manage:audit', 'manage:help', 'stats:workload:access', 'stats:workload:week', 'stats:workload:month', 'stats:workload:user-log', 'stats:workload:division', 'stats:workload:sheet1', 'stats:workload:sheet2', 'stats:workload:sheet3', 'stats:workload:sheet4', 'stats:workload:sheet5', 'stats:workload:sheet6', 'stats:workload:sheet7', 'stats:workload:sheet8', 'stats:workload:sheet9', 'stats:workload:sheet10'] },
    ...
    <Box>
      <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 2 }}>
        <Stack direction="row" spacing={1.5} alignItems="center">
          <Button variant="outlined" startIcon={<ArrowBackIcon />} onClick={() => navigate('/manage')}>返回系统管理</Button>
