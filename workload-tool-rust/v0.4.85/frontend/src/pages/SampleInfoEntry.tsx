                    ...
                    return (
                      <React.Fragment key={r.id}>
                        ...
                        >
                          ...
                          {listColumns.filter(c => !['status', 'seq_no'].includes(c.field_key)).map(col => (
                            <TableCell key={col.field_key} sx={{ fontSize: '0.875rem', minWidth: col.data_type === 'attachment' ? 130 : col.width || 80, borderColor: '#e0e0e0', whiteSpace: 'normal', wordBreak: 'break-word' }}>
