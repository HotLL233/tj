              ...
              <TableRow sx={{ bgcolor: 'rgba(230,81,0,0.06)' }}>
                {displayColumns.map(col => (
                  <TableCell key={col.name} sx={{
                    ...
                    overflowWrap: 'anywhere',
                    wordBreak: 'break-word',
                    width: getRecordColumnWidth(col.name),
                ...
                <TableCell sx={{ fontWeight: 700, fontSize: '0.78rem', width: 96, px: 0.75, py: 1, textAlign: 'center' }}>操作</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {records.map((rec, idx) => {
                ...
                return (
                  <TableRow key={rec.id} hover sx={{ '&:last-child td': { borderBottom: 0 }, verticalAlign: 'top' }}>
                    ...
                    <TableCell sx={{ ...recordCellSx, width: 96, textAlign: 'center', whiteSpace: 'nowrap' }}>
                      {isEditing ? (
