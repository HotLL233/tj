...
SetupIconFile=D:\桌面\工作量统计工具项目\workload-tool-rust\v0.3.23\icon.ico
Compression=lzma
...
[Files]
Source: "D:\桌面\工作量统计工具项目\workload-tool-rust\v0.3.23\dist\workload-tool.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\桌面\工作量统计工具项目\workload-tool-rust\v0.3.23\static\*"; DestDir: "{app}\static"; Flags: ignoreversion recursesubdirs
